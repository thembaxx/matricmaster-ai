...
async function seed() {
	...
	const subjectIds = await db.insert(subjects).values([
		{ name: 'Mathematics', description: 'Mathematics P1 & P2', curriculumCode: 'MAT', isActive: true },
		{ name: 'Physical Sciences', description: 'Physics & Chemistry', curriculumCode: 'PHY', isActive: true },
		{ name: 'English FAL', description: 'English First Additional Language', curriculumCode: 'ENG', isActive: true },
