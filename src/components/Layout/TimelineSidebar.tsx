		...
		>
			...
			>
				...
				<div className="relative flex-shrink-0 pt-1">
					<div className={cn('size-3 rounded-full', dotStyles[event.status])} />
				</div>
				...
				{/* Emoji */}
				<div className="flex-shrink-0 size-8 rounded-full bg-background flex items-center justify-center text-lg shadow-sm overflow-hidden">
