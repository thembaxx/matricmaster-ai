							...
							>
								<DialogHeader className="pb-2 pt-6 px-6">
									...
									>
										...
										<div>
											<DialogTitle className="text-xl font-semibold">AI Quota Exceeded</DialogTitle>
								...
								<div className="px-6 pb-6">
									...
									>
										<p className="text-sm text-foreground leading-relaxed">
											You've hit our shared AI usage limit. Don't worry! You can continue using AI
											features by adding your own Google AI API key, which gives you{' '}
											<span className="font-medium">free monthly credits</span> to use however you
											like.
										</p>
									</m.div>
