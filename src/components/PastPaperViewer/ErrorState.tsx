...
export function ErrorState({ paper, error, onRetry, onViewPdf }: ErrorStateProps) {
			...
			<div className="flex-1 flex flex-col items-center justify-center p-6">
				<div className="text-center space-y-4 max-w-sm">
					...
					<div className="flex flex-col gap-2">
						<Button className="bg-brand-blue text-white" onClick={onRetry}>
							Try Again
						</Button>
						<Button variant="outline" onClick={onViewPdf} className="gap-2">
