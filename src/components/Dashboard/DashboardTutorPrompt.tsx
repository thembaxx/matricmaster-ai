...
import { ThinkingAnimation } from '@/components/Tutor/ThinkingAnimation';

export function DashboardTutorPrompt() {
		...
		<div className="relative w-full max-w-2xl mx-auto">
			...
			>
				...
				<input
					...
					placeholder="Ask a personal tutor anything..."
			...
			<div className="mt-4 flex flex-wrap justify-center gap-2">
				{['Create a study plan', 'Explain calculus', 'Practice quiz'].map((suggestion) => (
					<button
						...
						className="px-4 py-2 rounded-full bg-white/5 border border-white/5 hover:bg-white/10 hover:border-white/10 text-[10px] font-black uppercase tracking-[0.2em] text-muted-foreground transition-all"
					>
						{suggestion}
					</button>
				))}
