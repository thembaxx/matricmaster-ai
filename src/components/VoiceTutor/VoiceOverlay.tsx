	...
	return (
		<div className="p-6">
			<div className="text-center mb-6">
				<div className="inline-flex items-center justify-center p-3 rounded-full bg-primary/10 mb-4 mx-auto w-fit">
					<HugeiconsIcon icon={SparklesIcon} className="w-8 h-8 text-primary" />
				</div>
				<h1 className="text-2xl font-bold mb-2">voice ai tutor</h1>
				<p className="text-muted-foreground text-sm">study hands-free with voice interaction</p>
			</div>
