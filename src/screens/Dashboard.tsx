		...
		<div className="flex-1 overflow-y-auto no-scrollbar pb-24">
			...
			<header className="px-6 pt-10 pb-6 flex justify-between items-center bg-white/50 dark:bg-zinc-900/50 backdrop-blur-md sticky top-0 z-10">
				...
				<div className="flex items-center gap-2 bg-white dark:bg-zinc-800 p-1 pr-3 rounded-full shadow-sm">
					<div className="w-8 h-8 rounded-full bg-blue-100 flex items-center justify-center overflow-hidden">
						<img
							src="https://lh3.googleusercontent.com/aida-public/AB6AXuDQcir7nh51t_DOlwZTtFOZ4oQO2O_q_NjhNZDH4taxDeKvqx6nzLnHrXUXFbqUgZJ0qwBstH9b_fJRJxADvmNrftalekUzPqV2KazupXgbdY9ObNVeW_V_k0nsVPK21J1nlcNUvkRiNwxtnSus-OdvpMoWmN52WWmOEF8I_WiepUql3BD7YY775UDuF_Rwg7EOT-PYOMPCZQS60Cbc3gl_h7153nzwNRnA4Ew5M7yeyyHy7NJbku0ciXSZsoesGMJ6GHPwlQNnyqA-"
							alt="Avatar"
						/>
					</div>
			...
			<main className="px-6 space-y-8">
				...
				<section className="bg-white dark:bg-zinc-900 rounded-3xl p-6 shadow-sm border border-zinc-100 dark:border-zinc-800 relative overflow-hidden group transition-all hover:shadow-md">
					<div className="absolute top-0 right-0 w-32 h-32 bg-accent-yellow/10 rounded-full -mr-16 -mt-16 group-hover:scale-110 transition-transform" />
					...
					<div className="h-2 w-full bg-zinc-100 dark:bg-zinc-800 rounded-full overflow-hidden mb-6">
						<div className="h-full bg-accent-yellow w-2/3 rounded-full" />
					</div>
					<button
						type="button"
				...
				<section>
					<div className="flex justify-between items-center mb-4">
						...
						<button
							...
							className="text-xs font-bold text-accent-blue uppercase"
						>
							Edit
						</button>
					</div>
					<div className="grid grid-cols-2 gap-4">
						{SUBJECTS.map((subject) => (
							<div
								key={subject.id}
								className="bg-white dark:bg-zinc-900 p-4 rounded-2xl border border-zinc-100 dark:border-zinc-800 shadow-sm flex flex-col gap-3 group cursor-pointer active:scale-95 transition-all"
							>
				...
				<section>
					...
					<div className="flex gap-4 overflow-x-auto no-scrollbar pb-2">
						<button
							...
							className="flex-shrink-0 bg-white dark:bg-zinc-900 px-6 py-4 rounded-2xl border border-zinc-100 dark:border-zinc-800 flex flex-col items-center gap-2"
						>
