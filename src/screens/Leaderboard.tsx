					...
					<Card className="p-4 bg-zinc-900 dark:bg-zinc-950 border-zinc-800 shadow-2xl rounded-3xl relative overflow-hidden group">
						...
						<div className="flex items-center gap-4 relative z-10">
							...
							<div className="relative">
								...
								<div className="absolute -bottom-1.5 -right-1.5 bg-[#efb036] text-zinc-950 text-[8px] font-black px-1.5 py-0.5 rounded-full border border-white dark:border-zinc-950">
									YOU
								</div>
							</div>
							<div className="flex-1 min-w-0">
