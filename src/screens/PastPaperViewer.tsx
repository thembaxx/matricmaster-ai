...
export default function PastPaperViewer({
  ...
  const handleExplainQuestion = useCallback(async () => {
    ...
    try {
      ...
      setAiExplanation(
        explanation ??
          "I'm sorry, I couldn't generate an explanation for this question.",
      );
    } catch (err) {
          ...
          <div className="text-center space-y-4">
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-zinc-500">
                Using AI to parse the exam paper
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="flex flex-col  justify-between mb-4 gap-3">
          ...
          <div className="flex items-center gap-2">
            <Button
              ...
              size="sm"
              onClick={() =>
                setViewMode((v) => (v === "smart" ? "original" : "smart"))
              }
            ...
            <Card className="p-6 rounded-[2rem] border-none shadow-sm bg-card relative overflow-hidden">
              ...
              <div className="flex flex-col gap-3 items-start mb-6 relative z-10">
                ...
                {currentQuestion.topic && (
                  <Badge
                    variant="outline"
                    className="rounded-full text-xs dark:bg-zinc-900"
                  >
              ...
              {Array.from({ length: totalQuestions }, (_, i) => i)
                ...
                .map((i, _, arr) => {
                  const showEllipsis =
                    i > 0 &&
                    !arr.includes(i - 1) &&
                    !(Math.abs(i - currentQuestionIndex) <= 1);
                  return (
                    <>
                      {showEllipsis && (
                        <span
