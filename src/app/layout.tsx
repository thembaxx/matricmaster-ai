...
export const metadata: Metadata = {
	...
	description:
		'Master your Matric exams through interactive practice. Access past papers, step-by-step guides, and expert-guided explanations for South African Grade 12 students.',
	keywords: [
		'matric',
		'grade 12',
		'south africa',
...
const jsonLd = {
	...
	'@graph': [
		...
		},
		{
			...
			url: baseUrl,
			description:
				'Interactive past papers and step-by-step guides for South African Grade 12 students. Expert-guided explanations and practice for NSC exams.',
