...
import { 
  Users, Search, UserPlus, MessageCircle, 
...
const SUBJECTS = [
  ...
  "History", "English", "Afrikaans", "Accounting", "Economics"
];
...
export default function StudyBuddiesPage() {
  ...
  const filteredBuddies = discoverableBuddies.filter(buddy => {
    ...
    const matchesSubjects = selectedSubjects.length === 0 ||
      buddy.subjects.some(s => selectedSubjects.includes(s));
        ...
        <TabsContent value="my-buddies" className="space-y-4">
          {myBuddies.length > 0 ? (
            ...
            <Card>
              <CardContent className="py-12 text-center">
                <Users className="h-12 w-12 mx-auto mb-4 text-muted-foreground" />
                <p className="text-muted-foreground mb-4">You haven't connected with any study buddies yet</p>
        ...
        <TabsContent value="profile">
          <Card>
            ...
            <CardContent className="space-y-6">
              ...
              <div>
                <label className="text-sm font-medium mb-2 block">Subjects You Need Help With</label>
                <div className="flex gap-2 flex-wrap">
