...
export default function AiTutorError({ error, reset }: ErrorProps) {
	useEffect(() => {
		...
		<div className="flex flex-col items-center justify-center min-h-[60vh] p-6 bg-background">
			<div className="max-w-md w-full text-center space-y-6">
				...
				<div className="space-y-2">
					<h2 className="text-2xl font-bold text-foreground">ai tutor error</h2>
					<p className="text-sm text-muted-foreground">
						{error.message || 'unable to connect with the ai tutor. please try again.'}
					</p>
					{error.digest && (
