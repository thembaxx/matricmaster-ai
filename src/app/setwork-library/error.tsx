...
export default function SetworkLibraryError({ error, reset }: ErrorProps) {
	useEffect(() => {
		console.error('Setwork library error:', error);
	}, [error]);
			...
			<div className="max-w-md w-full text-center space-y-6">
				...
				<div className="space-y-2">
					...
					<p className="text-sm text-muted-foreground">
						{error.message || 'unable to load the setwork library. please try again.'}
					</p>
				</div>
