...
import { getSubjectFont, getSubjectName } from '@/content';
...
export default function SubjectDetailsPage() {
	...
	return (
		<ViewTransition default="none" enter="vt-blur-reveal" exit="vt-blur-reveal">
			<div className="min-h-screen bg-background p-4 sm:p-8 pb-32">
				...
				>
					...
					<ViewTransition name={`subject-icon-${subjectId}`} default="none" share="vt-expand">
