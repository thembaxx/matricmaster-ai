        ...
        <div className="flex-1 overflow-y-auto no-scrollbar bg-background-light dark:bg-background-dark relative">
            ...
            <div className="relative flex flex-col items-center py-20 min-h-[1200px]">
                ...
                <svg className="absolute top-0 w-full h-full pointer-events-none opacity-20" viewBox="0 0 400 1200">
                    <path d="M 200 0 C 200 200, 100 300, 100 500 C 100 700, 300 800, 300 1000" stroke="#a1a1aa" strokeWidth="6" fill="none" strokeDasharray="12 12" />
                </svg>
                ...
                <div className="flex flex-col items-center gap-32 relative z-10 w-full">
                    ...
                    <div className="flex flex-col items-center relative -translate-x-12">
                        ...
                        >
                            ...
                            <div className="absolute -top-2 -right-2 bg-accent-yellow text-[10px] font-black px-2 py-0.5 rounded-full border border-white">NEXT</div>
                        </button>
            ...
            <div className="sticky bottom-24 w-full px-6 z-30">
                <button onClick={() => onNavigate(Screen.QUIZ)} className="w-full bg-accent-blue py-4 rounded-2xl text-white font-bold shadow-lg shadow-blue-500/20 flex items-center justify-between px-6">
                    <div className="flex items-center gap-3">
                        <div className="w-8 h-8 rounded-full bg-white/20 flex items-center justify-center"><span className="material-symbols-rounded text-sm">play_arrow</span></div>
