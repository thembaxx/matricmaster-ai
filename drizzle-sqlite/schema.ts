...
(table) => [
	uniqueIndex("past_papers_paper_id_unique").on(table.paperId),
]);
...
export const studyBuddyProfiles = sqliteTable("study_buddy_profiles", {
	id: text().primaryKey().notNull(),
	userId: text("user_id").notNull(),
	bio: text(),
...
(table) => [
	uniqueIndex("study_buddy_profiles_user_id_unique").on(table.userId),
]);
